...
resource "local_file" "private_key_file" {
  filename        = "${path.module}/generated_londres_key.pem"
...
resource "local_file" "ansible_inventory" {
  ...
  content  = <<-EOT
    [wordpress]
    ${aws_instance.wordpress.public_ip} ansible_user=ubuntu ansible_ssh_private_key_file=${path.module}/generated_londres_key.pem
  EOT
}
