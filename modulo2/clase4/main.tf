...
# Data source para obtener la IP pública de la máquina que ejecuta Terraform
data "http" "my_ip" {
...
terraform {
  backend "s3" {
    ...
    key     = "ec2-práctica-modulo2-clase4/terraform.tfstate"  # Ruta y nombre del archivo de estado dentro del bucket
